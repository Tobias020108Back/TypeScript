...
Info seq  [hh:mm:ss:mss] FileWatcher:: Added:: WatchInfo: /user/username/projects/project/bower.json 2000 undefined Project: /user/username/projects/project/jsconfig.json WatchType: File location for typing installer
...
FsWatches::
/user/username/projects/project/bower.json: *new*
  {}
/user/username/projects/project/jsconfig.json:
  {}
...
//// [/tmp/globalcache/cache/node_modules/@types/jquery/index.d.ts]



TI:: [hh:mm:ss:mss] Installed typings ["@types/jquery@tsFakeMajor.Minor"]
TI:: [hh:mm:ss:mss] Installed typing files ["/tmp/globalcache/cache/node_modules/@types/jquery/index.d.ts"]
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/user/username/projects/project/jsconfig.json",
      "typeAcquisition": {
...
Info seq  [hh:mm:ss:mss] 	Files (2)
	/user/username/projects/project/app.js SVC-1-0 ""
	/tmp/globalcache/cache/node_modules/@types/jquery/index.d.ts Text-1 ""
...
ScriptInfos::
/tmp/globalcache/cache/node_modules/@types/jquery/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/project/jsconfig.json
