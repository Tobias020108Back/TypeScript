...
TI:: [hh:mm:ss:mss] Installed typing files ["/a/globalcache/data/node_modules/@types/jquery/index.d.ts","/a/globalcache/data/node_modules/@types/cordova/index.d.ts","/a/globalcache/data/node_modules/@types/lodash/index.d.ts","/a/globalcache/data/node_modules/@types/commander/index.d.ts"]
TI:: [hh:mm:ss:mss] Sending response:
    {
      "projectName": "/user/username/projects/app/test1.csproj",
      "typeAcquisition": {
...
1: /user/username/projects/app/test1.csproj *new*
...
1: /user/username/projects/app/test1.csproj
2: /user/username/projects/app/test2.csproj *new*
...
1: /user/username/projects/app/test1.csproj
2: /user/username/projects/app/test2.csproj

Info seq  [hh:mm:ss:mss] Running: /user/username/projects/app/test1.csproj
Info seq  [hh:mm:ss:mss] Starting updateGraphWorker: Project: /user/username/projects/app/test1.csproj
Info seq  [hh:mm:ss:mss] Finishing updateGraphWorker: Project: /user/username/projects/app/test1.csproj projectStateVersion: 2 projectProgramVersion: 1 structureChanged: true structureIsReused:: Not Elapsed:: *ms
Info seq  [hh:mm:ss:mss] Project '/user/username/projects/app/test1.csproj' (External)
Info seq  [hh:mm:ss:mss] 	Files (5)
	/user/username/projects/project/file3.d.ts Text-1 ""
	/a/globalcache/data/node_modules/@types/commander/index.d.ts Text-1 "declare const commander: { x: number }"
	/a/globalcache/data/node_modules/@types/cordova/index.d.ts Text-1 "declare const cordova: { x: number }"
	/a/globalcache/data/node_modules/@types/jquery/index.d.ts Text-1 "declare const jquery: { x: number }"
	/a/globalcache/data/node_modules/@types/lodash/index.d.ts Text-1 "declare const lodash: { x: number }"
...
Info seq  [hh:mm:ss:mss] Running: /user/username/projects/app/test2.csproj
Info seq  [hh:mm:ss:mss] Starting updateGraphWorker: Project: /user/username/projects/app/test2.csproj
Info seq  [hh:mm:ss:mss] Finishing updateGraphWorker: Project: /user/username/projects/app/test2.csproj projectStateVersion: 2 projectProgramVersion: 1 structureChanged: true structureIsReused:: Not Elapsed:: *ms
Info seq  [hh:mm:ss:mss] Project '/user/username/projects/app/test2.csproj' (External)
Info seq  [hh:mm:ss:mss] 	Files (3)
	/user/username/projects/project/file3.d.ts Text-1 ""
	/a/globalcache/data/node_modules/@types/grunt/index.d.ts Text-1 "declare const grunt: { x: number }"
	/a/globalcache/data/node_modules/@types/gulp/index.d.ts Text-1 "declare const gulp: { x: number }"
...
ScriptInfos::
/a/globalcache/data/node_modules/@types/commander/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/app/test1.csproj
/a/globalcache/data/node_modules/@types/cordova/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/app/test1.csproj
/a/globalcache/data/node_modules/@types/grunt/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/app/test2.csproj
/a/globalcache/data/node_modules/@types/gulp/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/app/test2.csproj
/a/globalcache/data/node_modules/@types/jquery/index.d.ts *new*
    ...
    containingProjects: 1
        /user/username/projects/app/test1.csproj
/a/globalcache/data/node_modules/@types/lodash/index.d.ts *new*
    version: Text-1
    containingProjects: 1
        /user/username/projects/app/test1.csproj
/user/username/projects/project/file3.d.ts
