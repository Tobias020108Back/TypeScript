...
describe("unittests:: tsserver:: importHelpers", () => {
    ...
    it("import helpers sucessfully", () => {
        const type1 = {
            path: "/user/username/projects/project/type.ts",
            content: `
export type Foo {
    bar: number;
};`,
        ...
        const file1 = {
            path: "/user/username/projects/project/file1.ts",
            content: `
...
a.bar;`,
        ...
        const file3 = {
            path: "/user/username/projects/file3.js",
            content: "console.log('noop');",
        };
        const config2 = {
            path: "/user/username/projects/tsconfig.json",
            content: jsonToReadableText({
                include: ["**/*"],
            }),
        };
